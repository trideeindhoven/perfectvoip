				...
				if p.name=="condition" and (p.attr["wday"] or p.attr["minute-of-day"]) then
					...
					if startday <= dow and dow <= endday then
						...
						if Timestamp < beginningofday+startminute*60 then
							log.notice("sched_api "..beginningofday+startminute*60 .." callflowsched jeroen.lua "..call_flow_uuid .." true")
							res = api:execute("sched_api",beginningofday+startminute*60 .." callflowsched lua jeroen.lua "..call_flow_uuid .." true")
							log.notice("sched_api "..beginningofday+endminute*60 .." callflowsched jeroen.lua "..call_flow_uuid .." false")
							res = api:execute("sched_api",beginningofday+endminute*60 .." callflowsched lua jeroen.lua "..call_flow_uuid .." false")
						elseif Timestamp >= beginningofday+startminute*60 and Timestamp < beginningofday+endminute*60 then
							log.notice("lua jeroen.lua "..call_flow_uuid .." true")
							res = api:execute("lua","jeroen.lua "..call_flow_uuid .." true")
							log.notice("sched_api "..beginningofday+endminute*60 .." callflowsched jeroen.lua "..call_flow_uuid .." false")
							res = api:execute("sched_api",beginningofday+endminute*60 .." callflowsched lua jeroen.lua "..call_flow_uuid .." false")
						else
							log.notice("lua jeroen.lua "..call_flow_uuid .." false")
							res = api:execute("lua","jeroen.lua "..call_flow_uuid .." false")
						end
					else
						log.notice("lua jeroen.lua "..call_flow_uuid .." false")
						res = api:execute("lua","jeroen.lua "..call_flow_uuid .." false")
